...
public enum ErrorCodeEnum {
    ...
    HPAN_NOT_FOUND("C1004", "No card found with the requested Hpan"),
    USER_NOT_FOUND("C1005", "No citizen found with the requested tax code"),
    INVALID_SERVICE_VALUE("C1006", "Not all services with specified names exist");
