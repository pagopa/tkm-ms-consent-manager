...
public class DefaultBeans {
    ...
    public final TkmCitizen CITIZEN_WITH_GLOBAL_DENY_CONSENT_UPDATED =
            new TkmCitizen()
                    .setTaxCode(TAX_CODE)
    ...
    public final TkmCard PARTIAL_CITIZEN_VALID_CARD = new TkmCard().setId(1L).setHpan(HPAN).setCitizen(CITIZEN_WITH_PARTIAL_CONSENT).setDeleted(false);
    public final TkmCard PARTIAL_CITIZEN_VALID_CARD_2 = new TkmCard().setId(2L).setHpan(HPAN_2).setCitizen(CITIZEN_WITH_PARTIAL_CONSENT).setDeleted(false);
    public final List<TkmCard> PARTIAL_CITIZEN_CARDS_LIST = Arrays.asList(PARTIAL_CITIZEN_VALID_CARD, PARTIAL_CITIZEN_VALID_CARD_2);
    public final TkmCardService CARD_SERVICE_1 = new TkmCardService().setService(SERVICE_EXAMPLE).setCard(PARTIAL_CITIZEN_VALID_CARD).setConsentType(ConsentEntityEnum.Allow);
    public final TkmCardService CARD_SERVICE_2 = new TkmCardService().setService(SERVICE_EXAMPLE_2).setCard(PARTIAL_CITIZEN_VALID_CARD).setConsentType(ConsentEntityEnum.Allow);
    public final TkmCardService CARD_SERVICE_3 = new TkmCardService().setService(SERVICE_EXAMPLE_3).setCard(PARTIAL_CITIZEN_VALID_CARD).setConsentType(ConsentEntityEnum.Deny);
    public final TkmCardService CARD_SERVICE_4 = new TkmCardService().setService(SERVICE_EXAMPLE).setCard(PARTIAL_CITIZEN_VALID_CARD_2).setConsentType(ConsentEntityEnum.Allow);
    public final TkmCardService CARD_SERVICE_5 = new TkmCardService().setService(SERVICE_EXAMPLE_3).setCard(PARTIAL_CITIZEN_VALID_CARD_2).setConsentType(ConsentEntityEnum.Allow);
    public final List<TkmCardService> CARD_1_SERVICES = Arrays.asList(CARD_SERVICE_1, CARD_SERVICE_2, CARD_SERVICE_3);
    public final List<TkmCardService> CARD_1_SERVICES_SUB = Collections.singletonList(CARD_SERVICE_1);
    public final List<TkmCardService> CARD_2_SERVICES = Arrays.asList(CARD_SERVICE_4, CARD_SERVICE_5);
    public final String[] SERVICES_SUB_ARRAY = {ServiceEnum.BPD.toString(), ServiceEnum.FA.toString()};
